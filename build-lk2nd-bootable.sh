...
DEFAULT_CMDLINE='earlycon=msm_serial_dm,0x16440000 console=tty0 console=ttyMSM0,115200n8 ignore_loglevel loglevel=8 clk_ignore_unused pd_ignore_unused regulator_ignore_unused rdinit=/init panic=0'
