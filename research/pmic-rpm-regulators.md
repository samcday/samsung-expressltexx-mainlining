...
- PM8917 rails currently modeled are S4, L3, L4, L5, L6, and L7. L3 supplies HSUSB 3.3 V at `3075000` uV, L4 supplies HSUSB 1.8 V at `1800000` uV, L5 supplies SDCC1 `sdc_vdd` at `2950000` uV, S4 supplies SDCC1 `sdc_vdd_io` at `1800000` uV, L6 supplies SDCC3 `sdc_vdd` at `2950000` uV, and L7 supplies SDCC3 `sdc_vdd_io` at `1850000..2950000` uV.
...
- `linux/include/dt-bindings/mfd/qcom-rpm.h:173-183` assigns mainline resource IDs for the minimal PM8038/PM8917 MSM8930 RPM rails.
- `linux/drivers/mfd/qcom_rpm.c:341-367` adds the MSM8930 RPM resource table and template; `qcom_rpm.c:467` matches `qcom,rpm-msm8930`.
- `linux/drivers/regulator/qcom_rpm-regulator.c:918-952` adds minimal `qcom,rpm-pm8038-regulators` and `qcom,rpm-pm8917-regulators` support.
- `linux/arch/arm/boot/dts/qcom/qcom-msm8930.dtsi:87-96` adds the MSM8930 RPM node.
- `linux/arch/arm/boot/dts/qcom/qcom-msm8930-samsung-expressltexx.dts:91-140` declares the PM8917 S4/L3/L4/L5/L6/L7 regulators; `qcom-msm8930-samsung-expressltexx.dts:146-152` wires SDCC1 to L5/S4; `qcom-msm8930-samsung-expressltexx.dts:155-164` wires SDCC3 to L6/L7; `qcom-msm8930-samsung-expressltexx.dts:276-278` wires the USB PHY to L4/L3.
