...
- `build-lk2nd-bootable.sh:202-207` and `build-lk2nd-userdata.sh:234-239` now keep only the forced bring-up cmdline, `DEBUG_KERNEL`, and SMP fallback behavior from `DEBUG_BRINGUP=1`.
